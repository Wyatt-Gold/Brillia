    ...
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark font-display text-[#18272e] dark:text-white">
            ...
            <div className="flex items-center space-x-4">
              <div className="hidden sm:block">
                <label className="relative">
                  <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-[#46555c] dark:text-[#a0b3be]">search</span>
                  <input className="rounded-full bg-[#e8eaed] dark:bg-[#1a2b34] pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary w-40 md:w-56 transition-all duration-300 focus:w-48 md:focus:w-64" placeholder="Search..." type="search"/>
                </label>
              </div>
              <button className="p-2 rounded-full hover:bg-primary/20 transition-colors">
                <span className="material-symbols-outlined">notifications</span>
              </button>
              <div className="size-10 rounded-full bg-cover bg-center" style={{backgroundImage: 'url("https://lh3.googleusercontent.com/aida-public/AB6AXuAvRhEIF_I_J6qyq_PuNFXraoMefmGycb49KICuxlAbjMQSzEGVgSaKl0ipv74ajWdMVggbAuZ3xU-h6YqCtr3-VO7dxS3NdrP7goP18Wc2Fgs3CDMGd6G53BxhnvskWKQivYZ3JOEZeDI4s2hMWWUXPbaBGNVSGinmwyuBTWJrRjj97eDYIxaytIJUSBCL4_PRCGZuUe9rU2gDvC_8RS7zH45nI-khfoH_7c9w_dITVK3ikNcUW-6GfxshQTHWRN6VE169iewpHQ")'}}></div>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-2">Explore Subjects</h1>
          <p className="text-lg text-[#46555c] dark:text-[#a0b3be]">Choose a subject to start learning</p>
        </div>
