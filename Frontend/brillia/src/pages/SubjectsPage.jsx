...
export default function SubjectsPage() {
  ...
  const fallbackSubjects = [
    ...
    { id: "language-arts", name: "English Language Arts", icon: "menu_book" },
    ...
    { id: "other", name: "Other", icon: "extension" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background-light dark:bg-background-dark font-display text-[#18272e] dark:text-white">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-lg bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200 text-center">
            <span className="material-symbols-outlined align-middle mr-2">warning</span>
            Unable to connect to server. Showing cached subjects.
          </div>
        )}
